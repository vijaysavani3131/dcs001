...
SHA-256: `e3d8052b2f16dfe3163f1376a1dda682f170d5efde53085547252ec46ce671af`
...
Backend PHP files passed local `php -l` syntax validation. Android source is structured for AGP 9.4 / compileSdk 37 / minSdk 28 and GitHub CI is included in the generated ZIP. The local execution environment did not contain an Android SDK or Composer dependency cache, so full dependency-resolved APK/Laravel runtime builds should be run in CI or the developer workstation.
